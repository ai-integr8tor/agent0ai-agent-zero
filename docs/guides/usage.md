...
Speech-to-text settings live in the Whisper STT plugin card and include model size, language code, silence threshold, and recording behavior. The microphone button appears in the chat input when `_whisper_stt` is enabled.
